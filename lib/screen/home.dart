...
import 'package:myapp/screen/actual.dart';
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            ...
            icon: FlatButton.icon(
                onPressed: () {
                  //Navigator.pushNamed(context, Router.plannerRoute);
                },
                icon: Icon(
                  Icons.assignment,
                  size: 40.0,
          ...
          BottomNavigationBarItem(
            ...
            icon: FlatButton.icon(
                onPressed: () {
                  //Navigator.pushNamed(context, Router.metricsRoute);
                },
                icon: Icon(
                  Icons.insert_chart,
                  size: 40.0,
          ...
          BottomNavigationBarItem(
            ...
            icon: FlatButton.icon(
                onPressed: () {
                  //Navigator.pushNamed(context, Router.actualRoute);
                },
                icon: Icon(
                  Icons.mode_edit,
                  size: 40.0,
          ...
          BottomNavigationBarItem(
            ...
            icon: FlatButton.icon(
                onPressed: () {
                  //Navigator.pushNamed(context, Router.planVsActualRoute);
                },
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          onTap: () {
            ...
            Navigator.pushNamed(context, Router.dashboardRoute);
          },
        ),
        ListTile(
          ...
          title: Text('Menu'),
          onTap: () {
            Navigator.pushNamed(context, Router.menuRoute);
          },
        ),
        ListTile(
          ...
          title: Text('Reports'),
          onTap: () {
            Navigator.pushNamed(context, Router.reportsRoute);
          },
        ),
        ListTile(
          ...
          title: Text('Gallery'),
          onTap: () {
            Navigator.pushNamed(context, Router.galleryRoute);
          },
        ),
        ListTile(
        ...
        ListTile(
          ...
          title: Text('Feedback'),
          onTap: () {
            Navigator.pushNamed(context, Router.feedbackRoute);
          },
        ),
        ListTile(
          ...
          title: Text('Support'),
          onTap: () {
            Navigator.pushNamed(context, Router.supportRoute);
          },
        ),
        ListTile(
          ...
          title: Text('Help'),
          onTap: () {
            Navigator.pushNamed(context, Router.helpRoute);
          },
        ),
        ListTile(
          ...
          title: Text('Logout'),
          onTap: () {
            Navigator.pushNamed(context, Router.logoutRoute);
          },
        ),
      ],
    ),
